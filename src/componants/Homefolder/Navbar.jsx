      ...
      onChange={(e)=> setSearchData(e.target.value)}
       ...
       >
        ...
        <div className="hidden md:flex space-x-4 items-center ml-2  ">
          <a href="#" className="hover:text-yellow-400 transition duration-200 text-sm md:text-base font-semibold">Watchlist</a>
              ...
              <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
                <div className="bg-white text-gray-800 rounded-lg shadow-lg p-6 w-11/12 md:w-1/3 relative">
                  ...
                  <form>
                    ...
                    <input type="email" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring focus:ring-yellow-500 mb-4" placeholder="Email" />
                    <input type="password" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring focus:ring-yellow-500 mb-4" placeholder="Password" />
                    <button type="submit" className="w-full bg-yellow-500 text-white py-2 rounded-lg hover:bg-yellow-600 transition duration-200">Login</button>
                  </form>
                </div>
              </div>
            )}
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-gray-800 text-white p-4">
          <div className="flex flex-col items-center space-y-4">
            <a href="#" className="block text-center hover:text-yellow-400 transition duration-200 text-base">Watchlist</a>
            <button onClick={() => setIsLoginOpen(!isLoginOpen)} className="block text-center hover:text-yellow-400 transition duration-200 text-base">Sign In</button>
          </div>

          {/* <div className="flex items-center mt-4">
            <select className="bg-gray-700 text-white rounded-lg px-0 py-2 border border-gray-600">
              <option>All</option>
              <option>Movies</option>
              <option>TV Shows</option>
            </select>
...
<input
      ...
      className="flex items-center justify-center px-6 py-3 text-white bg-blue-600 rounded-lg transition duration-300 ease-in-out transform hover:bg-blue-500 hover:scale-105 focus:outline-none"
    >
...
{/* <button
  onClick={handleSearch}
  className="flex w-28 items-center justify-center mt-2 px-3 py-2 text-white bg-blue-600 rounded-lg transition duration-300 ease-in-out transform hover:bg-blue-500 hover:scale-105 focus:outline-none"
>
  <span className="mr-1">🔍</span>
  Search
</button> */}
